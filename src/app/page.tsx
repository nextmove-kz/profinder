...
export default function Home() {
  return (
    <div className="text-white flex h-screen justify-center items-center overflow-hidden bg-[url('../../public/background_11.jpg')] bg-cover bg-center">
      <header className="absolute top-6 right-2 px-4 lg:px-6 h-14 flex">
      ...
      <main className="w-full">
        <div className="flex flex-col gap-4 items-center justify-center mt-36">
